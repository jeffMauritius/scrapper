...
async function main() {
  try {
    ...
    // Sélectionner les établissements 5001 à 6500
    const venuesToImport = venues.slice(5000, 6500);
    console.log(`Import des établissements 5001 à 6500 sur ${venues.length} disponibles...`);
