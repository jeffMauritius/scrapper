    ...
    for (const card of cardsToProcess) {
      try {
        ...
        const data = await card.evaluate((el: Element) => {
          const nameEl = el.querySelector('.vendorTile__title');
          const ratingEl = el.querySelector('.vendorTile__rating');
          ...
          const linkEl = el.querySelector('a.vendorTile__link') as HTMLAnchorElement;
          const imageEl = el.querySelector('.vendorTile__image img') as HTMLImageElement;
          const typeEl = el.querySelector('.vendorTile__subtitle');

          // Ajouter des logs pour déboguer
          console.log('\nDonnées trouvées dans la carte:');
          console.log('- Nom:', nameEl?.textContent);
          console.log('- Note:', ratingEl?.textContent);
          console.log('- Avis:', reviewsEl?.textContent);
          console.log('- Lieu:', locationEl?.textContent);
          console.log('- Prix:', priceEl?.textContent);
          console.log('- Capacité:', capacityEl?.textContent);
          console.log('- Description:', descriptionEl?.textContent);
          console.log('- URL:', linkEl?.href);
          console.log('- Image:', imageEl?.src);
          console.log('- Type:', typeEl?.textContent);
